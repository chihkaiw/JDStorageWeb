...
public class AppengineHttpRequestor extends HttpRequestor {
  ...
  /**
   * We pass this value to {@link HttpURLConnection#setConnectTimeout}. You can change this setting
   * by creating a subclass and overriding {@link #configureConnection}.
   */
  public static final int DefaultConnectTimeoutMillis = 35 * 1000;

  /**
   * We pass this value to {@link HttpURLConnection#setReadTimeout}. You can change this setting by
   * creating a subclass and overriding {@link #configureConnection}.
   */
  public static final int DefaultReadTimeoutMillis = 35 * 1000;

  /**
   * A thread-safe instance of {@code StandardHttpRequestor} that connects directly (as opposed to
   * using a proxy).
   */
  ...
  /**
   * Can be overridden to configure the underlying {@link HttpURLConnection} used to make network
   * requests. If you override this method, you should probably call
